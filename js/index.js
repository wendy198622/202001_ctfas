...
const messages = {
  ...
  kh: {
    ...
    page6: {
      ...
      form_styleA: 'រចនាបថបែបលោកខាងលិច',
      form_styleB: 'រចនាបថប្រណីតបែបបារាំង',
      form_styleC: 'រចនាបថសាមញ្ញបែបជប៉ុន',
      form_age: 'អាយុ',
      form_ageA: 'អាយុក្រោម25ឆ្នាំ',
      form_ageB: '25ឆ្នាំ〜50ឆ្នាំ',
      form_ageC: 'អាយុចាប់ពី50ឆ្នាំឡេីងទៅ',
  ...
  en: {
    ...
    page6: {
      ...
      form_styleA: 'Modern Western Style',
      form_styleB: 'Luxury French Style',
      form_styleC: 'Simple Japanese Style',
      form_age: 'Age',
      form_ageA: 'Below 25 years old',
      form_ageB: 'Between 25 to 50 years old',
      form_ageC: 'Above 50 years old',
